...
extern int timf3_tmp_size;
extern float fft3_blocktime;
extern size_t *fft3_handle;
extern float *fft3;
extern float *fft3_tmp;
extern double *d_fft3;
extern double *d_fft3_tmp;
extern float *timf3_tmp;
extern double *d_timf3_tmp;
extern COSIN_TABLE *fft3_tab;
extern D_COSIN_TABLE *d_fft3_tab;
extern unsigned short int *fft3_permute;
extern unsigned int *fft3_bigpermute;
extern short int *fft3_spectrum;
extern float *fft3_window;
extern double *d_fft3_window;
extern float *fft3_power;
extern float *fft3_slowsum;
extern float *fft3_cleansum;
extern float *fft3_fqwin_inv;
extern double *d_fft3_fqwin_inv;
